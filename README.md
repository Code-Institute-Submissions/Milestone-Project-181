...
I wanted to create a user friendly website to show the necessary information for recruiters and employers.
...
I also gave users the option to download my CV for easy access.

## Surface:

I chose the blue background with the text color of white for my name and job title so that it would stand out.

The brown background was chosen along with the black text color so that again it would stand out and not be too distracting.

The orange background footer was chosen to compliment the white text colour.

## Icons:

I used Font Awesome for the social media icons of GitHub and LinkedIn.
...
On the CV page when the user clicks on the CV icon a copy of my CV will be opened in a new tab for users to view and download.
